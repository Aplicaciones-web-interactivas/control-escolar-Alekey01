...
<head>
    ...
    <title>Editar Calificación - Control Escolar</title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <nav class="bg-white shadow-sm">
        <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('calificaciones.index') }}" class="text-sm text-gray-600 hover:text-blue-600 transition">← Volver a calificaciones</a>
    ...
    <main class="max-w-lg mx-auto px-6 py-10">
        ...
        <div class="bg-white rounded-2xl shadow p-8">
            <h2 class="text-xl font-bold text-gray-800 mb-6">Editar calificación</h2>
            ...
            <form action="{{ route('calificaciones.update', $calificacion->id) }}" method="POST" class="space-y-5">
                @csrf
                @method('PUT')
                    ...
                    <select id="alumno_id" name="alumno_id" required
                        ...
                        @foreach ($alumnos as $alumno)
                            <option value="{{ $alumno->id }}"
                                {{ old('alumno_id', $calificacion->alumno_id) == $alumno->id ? 'selected' : '' }}>
                    ...
                    <select id="materia_id" name="materia_id" required
                        ...
                        @foreach ($materias as $materia)
                            <option value="{{ $materia->id }}"
                                {{ old('materia_id', $calificacion->materia_id) == $materia->id ? 'selected' : '' }}>
                ...
                <div>
                    <label for="calificacion" class="block text-sm font-medium text-gray-700 mb-1">Calificación (0 – 100)</label>
                    <input
                        type="number" id="calificacion" name="calificacion"
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('periodo', $calificacion->periodo) }}"
