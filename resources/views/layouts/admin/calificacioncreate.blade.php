...
<head>
    ...
    <title>Agregar Calificación - Control Escolar</title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <main class="max-w-lg mx-auto px-6 py-10">
        ...
        <div class="bg-white rounded-2xl shadow p-8">
            <h2 class="text-xl font-bold text-gray-800 mb-6">Agregar calificación</h2>
            ...
            <form action="{{ route('calificaciones.store') }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('calificacion') }}" required min="0" max="100" step="0.01"
