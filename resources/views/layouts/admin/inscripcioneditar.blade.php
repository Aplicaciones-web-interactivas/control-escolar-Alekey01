...
<head>
    ...
    <title>Editar Inscripción - Control Escolar</title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <main class="max-w-lg mx-auto px-6 py-10">
        ...
        <div class="bg-white rounded-2xl shadow p-8">
            <h2 class="text-xl font-bold text-gray-800 mb-6">Editar inscripción</h2>
            ...
            <form action="{{ route('inscripciones.update', $inscripcion->id) }}" method="POST" class="space-y-5">
                @csrf
                @method('PUT')
                    ...
                    <select id="materia_id" name="materia_id" required
                        ...
                        @foreach ($materias as $materia)
                            <option value="{{ $materia->id }}"
                                {{ old('materia_id', $inscripcion->materia_id) == $materia->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input
                        ...
                        value="{{ old('periodo', $inscripcion->periodo) }}"
